        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Новый пост</h1>
                        ...
                        <div class="row justify-content-center push">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="dm-post-add-title" name="title" placeholder="Напишите заголовок..">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="dm-post-add-excerpt" name="excerpt" rows="3" placeholder="Напишите краткое описание.."></textarea>
