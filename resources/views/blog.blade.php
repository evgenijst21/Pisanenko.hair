...
<div id="page-title" class="padding-tb-30px gradient-white text-up-small">
    <div class="container">
        ...
        <h1 class="font-weight-300">Все статьи</h1>
    </div>
</div>
            ...
            <div class="col-lg-8">
                ...
                <div class="blog-entry background-white border-1 border-grey-1 margin-bottom-35px box-shadow border-radius-10 overflow-hidden">
                    <div class="row no-gutters">
                        <div class="img-in col-lg-5"><a href="http://pisanenko.hair/blog/single/{{ $article->id }}"><img src="assets/img/{{$article->img}}" alt=""></a></div>
                        <div class="col-lg-7">
                            <div class="padding-lr-25px padding-tb-50px text-up-small">
                                ...
                                <div class="meta">
                                    ...
                                    <span class="text-small">Категория :  <a href="#" class="text-main-color"> {{$article->category->category_name}} </a></span>
                                </div>
                            </div>
                        </div>
                    </div>
